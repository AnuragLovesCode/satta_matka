...
const Jodiigit: React.FC<SingleDigitProps> = ({ isDoublePanna }) => {
  ...
  const onSubmit = (data: Bid) => {
    ...
    const defaultValues: Partial<Bid> = {
      ...
      game_type: "jodi_digit" // Provide the default game_type
    };
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="panna-new text-left mt-4">
            ...
            <div className="input-group">
              ...
              <input type="text" className="form-control" {...register("open_digit", { required: true, pattern: /^[0-9]$/ })} maxLength={9} placeholder="Enter Digit" />
            </div>
